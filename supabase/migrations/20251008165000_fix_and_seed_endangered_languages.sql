-- Fix language codes and seed endangered metadata
-- This migration corrects language codes and adds endangered metadata

-- Update language codes to correct ISO 639-3 codes
UPDATE public.languages SET code = 'kcy' WHERE name = 'Korandje';
UPDATE public.languages SET code = 'tia' WHERE name = 'Tidikelt';
UPDATE public.languages SET code = 'bga' WHERE name = 'Tchumbuli';
UPDATE public.languages SET code = 'tyu' WHERE name = 'Kua';
UPDATE public.languages SET code = 'nmn' WHERE name = 'Taa';
UPDATE public.languages SET code = 'yey' WHERE name = 'Yeyi';
UPDATE public.languages SET code = 'shg' WHERE name = 'Xaise';
UPDATE public.languages SET code = 'aku' WHERE name = 'Akum';
